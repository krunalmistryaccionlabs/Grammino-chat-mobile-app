...
export function updateContacts(phoneNumbers, token) {
  ...
  return new Promise((resolve, reject) => {
    axios
      .post(environment + "api/updateContacts", data, {
        headers: setHeaders({
          token: token
        })
      })
...
export function startConversation(phoneNumber, token) {
  ...
  return new Promise((resolve, reject) => {
    axios
      .post(environment + "api/conversation", data, {
        headers: setHeaders({
          token: token
        })
      })
...
export function postChatMessage(data, token) {
  return new Promise((resolve, reject) => {
    axios
      .post(environment + "api/chat", data, {
        headers: setHeaders({
          token: token
        })
      })
...
export function postChatImage(token, formData) {
  return new Promise((resolve, reject) => {
    axios
      .post(environment + "api/chat", formData, {
        headers: setHeaders2({
          token: token
        })
      })
...
export function postProfile(formData, token) {
  return new Promise((resolve, reject) => {
    axios
      .post(environment + "api/user/profile", formData, {
        headers: setHeaders2({
          token: token
        })
      })
...
export function postHelpMessage(data, token) {
  return new Promise((resolve, reject) => {
    axios
      .post(environment + "network/message", data, {
        headers: setHeaders({
          token: token
        })
      })
...
export function postChatImageHelp(token, formData) {
  return new Promise((resolve, reject) => {
    axios
      .post(environment + "network/message", formData, {
        headers: setHeaders2({
          token: token
        })
      })
