...
import { saveStorageData, saveUserToken, resetStore, changeLanguage } from './actions';
            ...
            <SafeAreaView>
                ...
                >
                    <View style={styles.center}>
                        <Header name={props.storageData.lan.my_profile} left={true} right={false} />
                    </View>
                    ...
                    <ScrollView style={{ backgroundColor: 'white', width: width }}>
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => logOut()}
                            >
                                <Text style={{ textAlign: 'center', fontSize: width * 0.07, color: 'white' }}>{props.storageData.lan.logout_value}</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
...
export default connect(mapStateToProps, { saveStorageData, saveUserToken, resetStore, changeLanguage })(profile)